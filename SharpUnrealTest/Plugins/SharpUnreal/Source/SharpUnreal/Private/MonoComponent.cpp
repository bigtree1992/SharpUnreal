...
void UMonoComponent::SendIntEventToMono(int Event)
{
	if (m_MonoComponent != NULL)
	{
		void *args[1];
		args[0] = &Event;
		MonoRuntime::Instance()->InvokeMethod(
			m_Callback->OnIntEvent, m_MonoComponent, args);
	}
}

void UMonoComponent::SendIntEventToMonoWithInt(int Event, int data)
{
	if (m_MonoComponent != NULL)
	{
		void *args[2];
		...
		args[1] = &data;
		MonoRuntime::Instance()->InvokeMethod(
			m_Callback->OnIntEventWithInt, m_MonoComponent, args);
	}
}

void UMonoComponent::SendIntEventToMonoWithFloat(int Event, float data)
{
	if (m_MonoComponent != NULL)
	{
		void *args[2];
		...
		args[1] = &data;
		MonoRuntime::Instance()->InvokeMethod(
			m_Callback->OnIntEventWithFloat, m_MonoComponent, args);
	}
}

void UMonoComponent::SendIntEventToMonoWithString(int Event, const FString& data)
{
	if (m_MonoComponent != NULL)
	{
		MonoString* s = mono_string_from_utf16((mono_unichar2*)*data);
		...
		args[1] = s;
		MonoRuntime::Instance()->InvokeMethod(
			m_Callback->OnIntEventWithString, m_MonoComponent, args);
	}
}

void UMonoComponent::SendIntEventToMonoWithVector(int Event, FVector data)
{
	if (m_MonoComponent != NULL)
	{
		void *args[2];
		...
		args[1] = &data;
		MonoRuntime::Instance()->InvokeMethod(
			m_Callback->OnIntEventWithVector, m_MonoComponent, args);
	}
}
