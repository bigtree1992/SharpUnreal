namespace UnrealEngine
{
    public partial struct Vector2D
    {
        ...
        static public readonly Vector2D ZeroVector = new Vector2D(0, 0);

        /** Global 2D unit vector constant (1,1) */
        static public readonly Vector2D UnitVector = new Vector2D(1, 1);
         ...
         */
        public static Vector2D operator +(Vector2D A, Vector2D V)
        {
            return new Vector2D(A.X + V.X, A.Y + V.Y);
        }
        /**
        ...
        */
        public static Vector2D operator *(Vector2D A, float Scale)
        {
        ...
        public static Vector2D operator /(Vector2D A, float Scale)
        {
            ...
            return new Vector2D(A.X * RScale, A.Y * RScale);
        }
        /**
        ...
        */
        ...
        public static bool operator ==(Vector2D This, Vector2D Other)
        {
        ...
        public static float operator |(Vector2D A, Vector2D V)
        {
        ...
        */
         ...
         */
        public static float DistSquared(Vector2D V1, Vector2D V2)
        {
            return (float)System.Math.Pow((V2.X - V1.X),2) + (float)System.Math.Pow((V2.Y - V1.Y),2);
        }
        ...
        {
            return (float)System.Math.Sqrt(Vector2D.DistSquared(V1, V2));
        }
         ...
         */
        public Vector2D GetRotated(float AngleDeg)
        {
            float S, C;
            Math.SinCos(out S, out C, 0.0174532925f *AngleDeg);
         ...
         */
        public Vector2D GetSafeNormal(float Tolerance = Const.SMALL_NUMBER)
        {
